...
docker build --platform linux/amd64 --pull=false --tag bee/bee:v1.3.9-amd64 --file docker/linux-amd64/03-build-app-image/Dockerfile .
docker build --platform linux/amd64 --pull=false --tag bee/bee:v1.3.8-amd64 --file docker/linux-amd64/03-build-app-image/Dockerfile .
docker build --platform linux/amd64 --pull=false --tag bee/bee:v1.3.7-amd64 --file docker/linux-amd64/03-build-app-image/Dockerfile .
