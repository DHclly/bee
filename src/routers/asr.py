...
router = APIRouter()
@router.post(path="/asr",
            tags=["ASR(Automatic Speech Recognition) API"],
...
async def asr(args:BeeChatArgs,token: str = Depends(get_bearer_token))->BeeChatResult | StreamingResponse | APIErrorResult:
