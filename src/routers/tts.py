...
router = APIRouter()
@router.post(path="/tts",
            tags=["TTS(Text To Speech) API"],
...
async def tts(args:BeeChatArgs,token: str = Depends(get_bearer_token))->BeeChatResult | StreamingResponse | APIErrorResult:
